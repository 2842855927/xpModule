...
public class HiddenAPIEnforcementPolicyUtils {
    ...
    private static void init() {
        try {
            ...
            Log.e("HiddenAPI", "error get methods"+ e.getMessage());
        }
    }
    ...
    public static void passApiCheck() {
        ...
        try {
            ...
            Log.e("HiddenAPI", "pass Hidden API enforcement policy failed  " + throwable.getMessage());
        }
    }
    ...
    public static void reverseApiCheck() {
        ...
        try {
            ...
            Log.e("HiddenAPI", "reverseApiCheck failed", throwable);
        }
    }
